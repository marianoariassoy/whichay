        ...
        <div className="container h-full px-14 m-auto max-w-7xl text-white flex items-end">
          <div className="pb-24">
            ...
            <Link to={`/obras/${item.id}`}>
              <button className="bg-primary h-11 font-mediym px-12 inline-block hover:bg-black hover:text-white hover:shadow-xl  transition-all">{lan === "es" ? "+VER MAS" : "+MORE"}</button>
            </Link>
          </div>
        </div>
      </div>
